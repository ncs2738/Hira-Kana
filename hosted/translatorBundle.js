...
var handleDate = function handleDate(e) {
  //Keep the page from refreshing
  e.preventDefault(); //Send the AJAX call with the translation forms form's data
...
var TranslationForm = function TranslationForm(props) {
  if (!updating) {
    ...
    return (/*#__PURE__*/React.createElement("form", {
        ...
        name: "_csrf",
        value: props.csrf
      }), /*#__PURE__*/React.createElement("button", null, "Remove"), /*#__PURE__*/React.createElement("input", {
        className: "textTranslationSubmit",
        type: "submit",
        value: "Save Translation"
      }))
...
var createWindow = function createWindow(csrf) {
  ...
  var data = document.querySelector("#translations");
  ...
  switch (currentWindow) {
    ...
    case "date":
      ...
      defaut: {
        ...
        ReactDOM.render( /*#__PURE__*/React.createElement(TranslationList, {
          translations: []
        }), data); //Load the data into the list
